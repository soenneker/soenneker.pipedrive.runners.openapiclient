...
using Soenneker.Pipedrive.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Pipedrive.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Pipedrive:ClientGenerationUrl"] ?? "https://developers.pipedrive.com/docs/api/v1/openapi-v2.yaml";
        ...
        await _processUtil.Start("kiota", gitDirectory, $"kiota generate -l CSharp -d \"{filePath}\" -o src/{Constants.Library} -c PipedriveOpenApiClient -n {Constants.Library}",
